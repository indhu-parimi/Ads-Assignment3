...
if __name__ == '__main__':
    ...
    df_years, df_countries = data_read(
        r"C:\Users\indhu\Downloads\worldbank_data.csv")
...
predict_future(r"C:\Users\indhu\Downloads\worldbank_data.csv", [
               'India', 'China', 'United States'], ['Methane emissions (kt of CO2 equivalent)'], 1990, 2019)
map_corr(df, size=8)
